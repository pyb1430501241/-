...
public abstract class ShiroUtils {
    ...
    @Nullable
	public static CurrentUser getNewsAccount() {
     ...
     */
    @Nullable
    public static CurrentUser getNewsAccount(@Nullable String sessionID, HttpServletRequest request, HttpServletResponse response) {
        try {
