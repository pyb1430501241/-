...
public final class EmailHelper {
	...
	private void sendEmail(String email, String subject, String msg) throws EmailException {
		...
		ee.setAuthentication("1430501241@qq.com", "qiwvhcotzqgsgahj");
	 ...
	 * @param email 邮箱
	 * @param name  用户名
	 * @throws org.apache.commons.mail.EmailException 邮箱不存在
	 */
	 ...
	 * @throws org.apache.commons.mail.EmailException 邮箱不存在
	 */
	public void sendEmailForRetrieveIphone(@NonNull final String email, @NonNull final String name) throws EmailException {
		text = RandomUtils.random();
